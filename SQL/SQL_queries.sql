...
if(EXISTS(SELECT * FROM Wishlist WHERE (name=@wishlistname)))
BEGIN
...
EXEC AddCreditCard '7','2020/12/1','1' ,'12312'

EXEC AddCreditCard '2','2020/12/1','1' ,'12312'
 
EXEC AddCreditCard '3','2020/12/1','1' ,'12312'
